class NoiseGenerator{
    ...
    createVectorGrid2(dimensions){
        ...
        let vectors = new Float32Array(length).fill().map(() => this.normalizedVector(dimensions.length));
...
function shapedArray(dimensions, defaulter, args){
    ...
    return shapeArray(dimensions, vectors);
    //Chonk complete.
}

function shapeArray(dimensions, vectors){
